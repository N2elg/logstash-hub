...
IF NOT %WRAPPER_SHA_256_SUM%=="" (
    powershell -Command "&{"^
       ...
       "  Write-Output 'Error: Failed to validate Maven wrapper SHA-256, your Maven wrapper installation is corrupt.';"^
       "  Write-Output 'Please re-run your Maven build without the MVNW_VERBOSE, MVNW_USERNAME or MVNW_PASSWORD environment variables set.';"^
       "  exit 1;"^
       "}"^
       "}"
